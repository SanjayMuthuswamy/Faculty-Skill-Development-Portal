...
from app.schemas.faculty import FacultyProfile as FacultySchema, FacultyProfileUpdate
from app.schemas.skill import FacultySkill as FacultySkillSchema, FacultySkillCreate
